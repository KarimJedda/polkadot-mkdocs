...
T = TypeVar("T", bound="PalletErrors")
...
class PalletErrors:
    ...
    Attributes:
        ...
        items (Union[Unset, list['PalletErrorsItemMetadata']]): Array containing metadata for each error entry of the
            pallet.
    """
    ...
    items: Union[Unset, list["PalletErrorsItemMetadata"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for items_item_data in _items or []:
            items_item = PalletErrorsItemMetadata.from_dict(items_item_data)
        ...
        pallet_errors.additional_properties = d
        return pallet_errors
