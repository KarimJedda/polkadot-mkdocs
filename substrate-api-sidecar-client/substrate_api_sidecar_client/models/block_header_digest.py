...
T = TypeVar("T", bound="BlockHeaderDigest")


@_attrs_define
class BlockHeaderDigest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        block_header_digest = cls(
            logs=logs,
        )

        block_header_digest.additional_properties = d
        return block_header_digest
