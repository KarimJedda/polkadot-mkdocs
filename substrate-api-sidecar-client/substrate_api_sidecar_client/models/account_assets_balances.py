...
T = TypeVar("T", bound="AccountAssetsBalances")


@_attrs_define
class AccountAssetsBalances:
    """
    Attributes:
        at (Union[Unset, BlockIdentifiers]): Block number and hash at which the call was made.
        assets (Union[Unset, list['AssetsBalance']]): An array of queried assets.
    """

    at: Union[Unset, "BlockIdentifiers"] = UNSET
    assets: Union[Unset, list["AssetsBalance"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for assets_item_data in _assets or []:
            assets_item = AssetsBalance.from_dict(assets_item_data)

            assets.append(assets_item)

        account_assets_balances = cls(
            at=at,
            assets=assets,
        )

        account_assets_balances.additional_properties = d
        return account_assets_balances
