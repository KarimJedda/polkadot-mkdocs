...
T = TypeVar("T", bound="PalletEvents")
...
class PalletEvents:
    ...
    Attributes:
        ...
        items (Union[Unset, list['PalletEventsItemMetadata']]):
    """

    at: Union[Unset, "BlockIdentifiers"] = UNSET
    pallet: Union[Unset, str] = UNSET
    pallet_index: Union[Unset, str] = UNSET
    items: Union[Unset, list["PalletEventsItemMetadata"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for items_item_data in _items or []:
            items_item = PalletEventsItemMetadata.from_dict(items_item_data)
        ...
        pallet_events.additional_properties = d
        return pallet_events
