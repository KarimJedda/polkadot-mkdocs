...
T = TypeVar("T", bound="PalletConstants")


@_attrs_define
class PalletConstants:
    """
    Attributes:
        ...
        items (Union[Unset, list['PalletConstantsItemMetadata']]): Array containing metadata for each constant entry of
            the pallet.
    """
    ...
    items: Union[Unset, list["PalletConstantsItemMetadata"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for items_item_data in _items or []:
            items_item = PalletConstantsItemMetadata.from_dict(items_item_data)

            items.append(items_item)

        pallet_constants = cls(
            at=at,
            pallet=pallet,
        ...
        pallet_constants.additional_properties = d
        return pallet_constants
