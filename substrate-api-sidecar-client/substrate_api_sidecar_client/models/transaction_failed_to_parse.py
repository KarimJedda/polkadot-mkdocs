...
T = TypeVar("T", bound="TransactionFailedToParse")
...
class TransactionFailedToParse:
    ...
    Attributes:
        ...
        error (Union[Unset, str]): `Failed to parse a tx.`
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        transaction_failed_to_parse = cls(
            code=code,
            error=error,
        ...
        transaction_failed_to_parse.additional_properties = d
        return transaction_failed_to_parse
