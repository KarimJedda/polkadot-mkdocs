...
T = TypeVar("T", bound="NextAvailableId")


@_attrs_define
class NextAvailableId:
    """
    Attributes:
        at (Union[Unset, BlockIdentifiers]): Block number and hash at which the call was made.
        id (Union[Unset, str]): Next availabe liquidity pool's id. Example: 4.
    """
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        next_available_id = cls(
            at=at,
            id=id,
        )

        next_available_id.additional_properties = d
