...
from ...models.get_runtime_metadata_response_200 import GetRuntimeMetadataResponse200
...
) -> Optional[GetRuntimeMetadataResponse200]:
    if response.status_code == 200:
        response_200 = GetRuntimeMetadataResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[GetRuntimeMetadataResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get the runtime metadata in decoded, JSON form.
     ...
     Returns the runtime metadata as a JSON object. Substrate Reference: - FRAME Support:
