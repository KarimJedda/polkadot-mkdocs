...
from ...models.pallet_storage import PalletStorage
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/pallets/{pallet_id}/storage",
        "params": params,
    }
...
) -> Optional[Union[Error, PalletStorage]]:
    if response.status_code == 200:
        response_200 = PalletStorage.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Error, PalletStorage]]:
    return Response(
