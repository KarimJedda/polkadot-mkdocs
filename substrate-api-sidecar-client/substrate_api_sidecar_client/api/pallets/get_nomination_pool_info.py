...
from ...models.pallets_nomination_pools_info import PalletsNominationPoolsInfo
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/pallets/nomination-pools/info",
        "params": params,
    }
...
) -> Optional[PalletsNominationPoolsInfo]:
    if response.status_code == 200:
        response_200 = PalletsNominationPoolsInfo.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PalletsNominationPoolsInfo]:
    return Response(
