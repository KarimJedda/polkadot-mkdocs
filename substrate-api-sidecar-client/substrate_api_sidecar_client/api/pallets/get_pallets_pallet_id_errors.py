...
from ...models.pallet_errors import PalletErrors
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/pallets/{pallet_id}/errors",
        "params": params,
    }
...
) -> Optional[Union[Error, PalletErrors]]:
    if response.status_code == 200:
        response_200 = PalletErrors.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Error, PalletErrors]]:
    return Response(
