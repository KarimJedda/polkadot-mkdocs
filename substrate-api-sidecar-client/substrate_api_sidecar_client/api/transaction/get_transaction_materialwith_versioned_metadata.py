...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/transaction/material/{metadata_version}",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Get all the network information needed to construct a transaction offline and the version of
    metadata specified in `metadataVersion`.
