...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/paras/head/backed-candidates",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    """[DEPRECATION NOTE: PHASED OUT ENDPOINT IN FAVOR OF CORETIME] Get the heads of the backed parachain
    candidates at the specified block height or at the most recent finalized head otherwise.
